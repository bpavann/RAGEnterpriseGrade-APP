...
# --- PAGE CONFIG ---
st.set_page_config(
    page_title="RAG Enterprise-Grade Agentic Assistant",
    page_icon="💻",
    layout="wide",
)
...
if "session_id" not in st.session_state:
    ...
    logfire.info(f"🕹️ New User Session Created: {st.session_state.session_id}")
...
# --- MAIN CHAT ---
st.title("💻 RAG Enterprise-Grade Agentic Assistant")
